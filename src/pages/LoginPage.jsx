...
function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true);
    // Simulasi delay sedikit biar kerasa loadingnya
            ...
            <div className="max-w-sm mx-auto w-full">
              ...
              <form onSubmit={handleLogin} className="space-y-6 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                <div className="space-y-2">
                  ...
                  {/* Input Group dengan Focus Animation */}
                ...
                {/* Button dengan Hover Scale & Arrow Slide */}
                <Button 
                  type="submit" 
                ...
                >
                  {loading ? (
                    ...
                    <>
                      Sign In 
                      {/* Panah geser kanan pas di hover */}
