...
function DashboardPage() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      savedState.currentIndex < savedState.questions.length
    ) {
    ...
    <div className="w-full min-h-screen font-sans transition-colors duration-300">
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        ...
        <section className="mb-12">
          <div
            className="flex items-center gap-2 mb-6 border-l-4 border-orange-500 pl-4"
            data-aos="fade-right"
            data-aos-delay="100"
          >
            <Target className="text-orange-500" />
            <h2 className="font-bold text-2xl text-gray-800 dark:text-white">Pick a Topic</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {CATEGORIES.map((cat, index) => (
              ...
              >
                <CategoryCard category={cat} onClick={handleStartQuiz} />
              </div>
            ))}
          </div>
        </section>
        ...
        <section>
          <div
            className="flex items-center justify-between mb-6 border-l-4 border-gray-400 pl-4"
            data-aos="fade-right"
            data-aos-offset="50"
          >
            <div className="flex items-center gap-2">
              <History className="text-gray-600 dark:text-gray-300" />
              <h2 className="font-bold text-2xl text-gray-800 dark:text-white">Recent Activity</h2>
            </div>
